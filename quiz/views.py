...
class QuizTake(FormView):
    ...
    def final_result_user(self):
        ...
        if self.quiz.id==1:
            get_user.step1=self.sitting.get_percent_correct
        elif self.quiz.id==2:
            get_user.step2=self.sitting.get_percent_correct
        elif self.quiz.id==3:
            get_user.step3=self.sitting.get_percent_correct
        elif self.quiz.id==4:
            get_user.step4=self.sitting.get_percent_correct
        get_user.save()
