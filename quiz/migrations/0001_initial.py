    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('collegeid', models.ForeignKey(db_column='collegeid', on_delete=django.db.models.deletion.DO_NOTHING, to='quiz.college')),
            ],
            options={
                'db_table': 'wishlist',
                'managed': True,
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('substreamid', models.ForeignKey(db_column='substreamid', on_delete=django.db.models.deletion.DO_NOTHING, to='quiz.subcategory')),
            ],
            options={
                'db_table': 'course',
                'managed': True,
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('collegename', models.ForeignKey(db_column='collegename', on_delete=django.db.models.deletion.DO_NOTHING, to='quiz.college')),
                ('coursename', models.ForeignKey(db_column='coursename', on_delete=django.db.models.deletion.DO_NOTHING, to='quiz.course')),
            ],
            options={
                'db_table': 'college_course',
                'managed': True,
            },
        ),
    ]
