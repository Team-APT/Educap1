...
class Course(models.Model):
    ...
    substreamid = models.ForeignKey('SubCategory', models.DO_NOTHING, db_column='substreamid')
...
class WishlistItem(models.Model):
    ...
    class Meta:
        ...
        ordering = ['-created']
        UniqueConstraint(fields=['user','item'], name='unique_wish')

class PhoneConsult(models.Model):
